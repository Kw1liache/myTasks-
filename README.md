# Мои учебные задания и не только
...
- **Архитектура ЭВМ** - Решения учебных задач по архитектуре ЭВМ на языке HDL
...
- Хранения reference-решений типовых задач по C# Python
